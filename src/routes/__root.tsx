...
function NotFoundComponent() {
  return (
    <div className="flex min-h-screen items-center justify-center bg-[var(--bg-base)] px-4 text-white">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-full bg-[var(--brand)] px-5 py-2.5 text-sm font-semibold text-[#0a0f0d] hover:bg-[var(--brand-hover)]"
          >
            Go home
          </Link>
        </div>
      ...
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          <button
            ...
            className="inline-flex items-center justify-center rounded-full bg-[var(--brand)] px-5 py-2.5 text-sm font-semibold text-[#0a0f0d]"
          >
            Try again
          </button>
          <a
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Heilares OÜ — Päikeseenergia spetsialistid" },
      {
        name: "description",
        content:
      ...
      { property: "og:description", content: "Võtmed kätte päikesepaneelide paigaldus Eestis ja üle Euroopa. Tracker park, maapark, katusepark." },
      { name: "twitter:description", content: "Võtmed kätte päikesepaneelide paigaldus Eestis ja üle Euroopa. Tracker park, maapark, katusepark." },
